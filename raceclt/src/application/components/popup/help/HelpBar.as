package application.components.popup.help
{
	...
	public class HelpBar extends HGroup
	{		
		...
		public function showGroups(selectedIndex:int = 0) : void {	
			var tabwidth:int = 123;
			
//			var sc1:ShopCategory = new ShopCategory(CategoryType.GAME_RULE, "Правила игры");
//			var tab1:CatalogTab = new CatalogTab();
//			tab1.width = tabwidth;
//			tab1.init(sc1);
			
			var sc2:ShopCategory = new ShopCategory(CategoryType.CHAT_RULE, "Правила чата");
			var tab2:CatalogTab = new CatalogTab();
			tab2.width = tabwidth;
			tab2.init(sc2);
			
			var sc3:ShopCategory = new ShopCategory(CategoryType.POSTS, "Должности");
			var tab3:CatalogTab = new CatalogTab();
			tab3.width = tabwidth;
			tab3.init(sc3);
			
			var sc4:ShopCategory = new ShopCategory(CategoryType.SETTINGS, "Настройки");
