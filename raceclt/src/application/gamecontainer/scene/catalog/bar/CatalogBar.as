package application.gamecontainer.scene.catalog.bar
{
	...
	{	
		...
		public function showGroups() : void {
			var sc1:ShopCategory = new ShopCategory(CategoryType.VIP, "Vip-аккаунты");
			var tab1:CatalogTab = new CatalogTab();
			tab1.width = 120;
			tab1.init(sc1);
			
			var sc2:ShopCategory = new ShopCategory(CategoryType.RENT_AUTO, "Прокат авто");
			var tab2:CatalogTab = new CatalogTab();
			tab2.width = 100;
			tab2.init(sc2);
			
			var sc3:ShopCategory = new ShopCategory(CategoryType.AUTO, "Авто");
